    ...
    try:
        ...
        return {
            ...
            "data": {
                ...
                "repair_maintainance": to_percentage(data.get("repair_&_maintainance_machine value")),
                "other_overheads": to_percentage(data.get("other_overheads_machine value")),
                "depreciation_on_plant_machinery": to_percentage(data.get("depreciation_on_plant_&_machinery_pct")),
                "depreciation_on_building": to_percentage(data.get("depreciation_on_building_pct")), 
                ...
                "efficiency": to_percentage(data.get("efficiency")),
